...
class Page extends React.Component {
  constructor(props) {
    ...
    let infos = props.infos,
        {breadcrumbs, dataSource, openMenu} = props.infos;
    ...
    this.state = {
      ...
      defaultAddressIds: getLocInfo(locations, openMenu),
      filter: {
        cur_page_num: 1,
        per_page_num: 10
      },
